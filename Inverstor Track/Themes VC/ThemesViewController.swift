...
// MARK:- ThemesVC Extension for Collection view
...
extension ThemesViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
       let cell = collectionView.dequeueReusableCell(withReuseIdentifier: ThemesCollectionViewCell.identifier, for: indexPath) as? ThemesCollectionViewCell ?? ThemesCollectionViewCell()
